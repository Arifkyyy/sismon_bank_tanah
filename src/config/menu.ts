  ...
  user: [
    {
      ...
      item: [
        { id: 'dash', label: 'Dashboard', path: '', ikon: 'Grid' },
        { id: 'logbook', label: 'Logbook', path: 'logbook', ikon: 'Buku' },
...
export const JUDUL: Record<string, [string, string]> = {
  ...
  logbook: ['Logbook', 'Catat aktivitas Anda hari ini'],
  'rekap-harian': ['Rekap harian', 'Ringkasan logbook dan kendala Anda'],
